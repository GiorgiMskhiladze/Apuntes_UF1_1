...
También está el **Modelo en V**, en la que los brazos derechos e izquierdos de desarollo del programa se unen en las pruebas, pero eso no significa que no se pueda avanzar una fase sin acabar la otra. Se hace una parte de la V y simultaniamente se hace la otra parte, una vez acabada las 2 se junta al final y se hacen las pruebas.
